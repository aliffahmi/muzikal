...
class RoomView(generics.CreateAPIView):
    ...
    # What we want to return? All fields
    queryset = Room.objects.all()
    
    # Finding which class to serialize from and how to serialize them
    ...
    def post(self, request, format=None):
        ...
        if code != None:
            ...
            if len(room_result) > 0:
                ...
                # To know which room the current user is in, so when they log off
                # they won't have to retype in the room code
